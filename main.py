...
if __name__ == "__main__":
    ...
    # how to cluster
    parser.add_argument("-clusteringtype", type = str, choices = ["clientorder", "random", "gradientsimilarity", "gradientbetween", "systemsimilarity", "fedch", "gradientgreedy_normseeding","gradientgreedy_cosineseeding","gradientgreedy", "bothgreedy","weightedbothgreedy"], default = "clusterbyrandomshuffle")
