...
if __name__ == "__main__":
    ...
    parser.add_argument("-systemheterogeneity", type = str, choices = ["alltimesame", "communicationtimesamecomputationdifferent","realistic", "comp100200random_comm100", "assume100clients95onelabeldominance_foreachlabel100200300400500of2randomlydistributed_comm3", "uniformdistribution", "uniformdistribution1", "uniformdistribution2", "uniformdistribution3"], default = "realistic")
    parser.add_argument("-clustercommunicationtime", type = int, default = 800)
    # how to cluster
    parser.add_argument("-clusteringtype", type = str, choices = ["clusterbyclientorder", "clusterbyrandomshuffle", "clusterbygradientsimilarity", "clusterbysystemsimilarity", "clusterbygradientbetween", "greedygradientvariance1", "greedygradientvariance2", "gradientgreedy1", "gradientgreedy2", "gradientgreedy3", "gradientgreedy4", "gradientgreedy5", "gradientgreedy6", "gradientgreedy7", "gradientgreedy8", "gradientgreedy9", "gradientgreedy10", "gradientgreedy11","gradientgreedy12", "gradientgreedy13", "gradientgreedy14", "gradientgreedy15", "gradientgreedy16", "gradientsystemgreedy1", "gradientsystemgreedy2", "gradientsystemgreedy3", "gradientsystemgreedy4", "gradientsystemgreedy5", "data_driven", "fedch"], default = "clusterbyrandomshuffle")
