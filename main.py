...
if __name__ == "__main__":
    ...
    # how to cluster
    parser.add_argument("-clusteringtype", type = str, choices = ["clusterbyclientorder", "clusterbyrandomshuffle","clusterbyrandomshufflecustom", "clusterbygradientsimilarity", "clusterbysystemsimilarity","clusterbygradientdissimilarity","clusterbygradientdissimilarityandsystemsimilarity"], default = "clusterbyrandomshuffle")
